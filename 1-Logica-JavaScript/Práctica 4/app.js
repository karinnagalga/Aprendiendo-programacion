...
let usuario = "Bienvenido usuario";
console.log(usuario);
...
//let usuario = prompt("Inserta tu nombre");
let lenguajeFavorito = prompt("¿Cuál es tu lenguaje d eprogramación que más te gusta?");
console.log(lenguajeFavorito);

//5. Crea una variable llamada "valor1" y otra llamada "valor2", asignándoles valores numéricos de 
...
//"resultado". Utiliza console.log para mostrar el mensaje "La diferencia entre [valor1] y [valor2] es 
...
console.log(resultado);
alert(`La diferencia de ${valor1} y ${valor2} es igual a ${resultado}`);

//7.Pide al usuario que ingrese su edad con prompt. Con base en la edad ingresada, utiliza un if 
...
//8.Crea una variable "numero" y solicita un valor con prompt. Luego, verifica si es positivo, negativo 
//o cero utilizando un if-else y muestra el mensaje correspondiente.
let numero = prompt("Inserta un número (positivo, negativo o cero)");
...
if(nota >= 7) {
    ...
    alert("¡Reprobaste, échale más ganas!")
}
